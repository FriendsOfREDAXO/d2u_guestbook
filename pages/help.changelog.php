...
<ul>
	...
	<li>Security: Die <code>save()</code>-Methode in <code>lib/Entry.php</code> verwendet jetzt gebundene Parameter statt SQL-String-Konkatenation mit <code>addslashes()</code>.</li>
    <li>Security: Modul-Ausgaben (<code>modules/60/1/output.php</code>, <code>modules/60/3/output.php</code>, <code>modules/60/4/output.php</code>, <code>modules/60/6/output.php</code>) härten von Besuchern eingereichte Inhalte (Name, E-Mail) gegen XSS via <code>rex_escape()</code> in HTML- und <code>mailto:</code>-Attributausgaben.</li>
    <li>Security: Eintragstexte (<code>description</code>) werden in den Modulen 60-1, 60-3, 60-4 und 60-6 vor der Ausgabe mit <code>nl2br()</code> jetzt zusätzlich über <code>rex_escape()</code> escaped, damit von Besuchern eingegebenes HTML nicht als Markup interpretiert wird.</li>
</ul>
<p>2.1.0:</p>
<ul>

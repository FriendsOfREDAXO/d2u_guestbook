...
class d2u_guestbook_lang_helper {
	...
	protected $replacements_english = [
		...
		'd2u_guestbook_form_privacy_policy' => 'I agree that my entry may be published. I have read the following linked Privacy Policy and accept them:',
	...
	protected $replacements_german = [
		...
		'd2u_guestbook_form_name' => 'Name',
		'd2u_guestbook_form_privacy_policy' => 'Ich erkläre mich damit einverstanden, dass mein Eintrag veröffentlicht wird. Die nachfolgend verlinkte Datenschutzerklärung habe ich gelesen und akzeptiere sie:',

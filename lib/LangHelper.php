...
class LangHelper extends \TobiasKrais\D2UHelper\ALangHelper
{
    ...
    public $replacements_english = [
        ...
        'd2u_guestbook_form_validate_spambots' => 'Too fast - it seems you are a spambot. Please take your time to fill out all fields.',
    ...
    protected array $replacements_german = [
        ...
        'd2u_guestbook_form_thanks' => 'Danke für Ihren Eintrag. Ihr Eintrag wird von unserem Administrator auf Spam und inakzeptable Sprache geprüft. Das kann einige Zeit in Anspruch nehmen. Es besteht kein Anspruch auf eine Veröffentlichung.',
